...
machine = TocMachine(
    ...
    transitions = [
        ...
        {"trigger": "is_going_to_rank", "source": ["Menu1", "Menu2","Menu3","subMenu","purchase_link"], "dest": "rank"},
        {"trigger": "go_back", "source":["user","Menu1", "Menu2","Menu3","subMenu","rank"], "dest": "user"},
        {"trigger": "is_going_to_Menu1", "source": ["user","Menu1", "Menu2","Menu3","subMenu","rank"], "dest": "Menu1"}
    ],
    initial="user",
